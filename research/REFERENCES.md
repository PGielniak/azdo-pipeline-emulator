...
| Expressions | https://learn.microsoft.com/azure/devops/pipelines/process/expressions — **deep-verified 2026-08-12** (E02-S04-T02). Includes logical/comparison/membership C-E02-028..032; general functions C-E02-040..051; member access C-E02-024..027; conversion C-E02-020..023; value model C-E02-018/019; grammar C-E02-002..009; context availability C-E02-080..091; dependency shapes C-E02-092..095. The live run confirms same-stage `dependencies` is empty without a job dependency while cross-stage `stageDependencies` is stage→job→`outputs['step.var']` plus metadata. |
...
| git-scm.com/docs · gnu.org/software/bash/manual/bash.html | git flag + shell semantics citations (both 200; deep-checked 2026-08-12 for quoting and exit status, C-E02-129/130) |
