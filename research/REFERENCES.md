...
that the enclosing job timeout terminates a longer-running step (C-E06-025).
...
| microsoft/azure-pipelines-tasks @ `6485321954dafb296697763c54c30a70840154f8` (HEAD checked 2026-08-19) · snapshot pin tag **v277** = `8ba25cfb` (2026-07-30) | Per-task `Tasks/<Name>V<n>/task.json` + implementation. Bash@3 and CmdLine@2 temp-script creation, cwd binding, and ordered live-output wiring deep-verified for E06-S03-T01 (C-E06-029); shared modules `Tasks/Common/` (Deployment, Sanitizer, TlsHelpers, …). Sprint-cadence release tags `v<sprint>`; versioning rules `docs/taskversionbumping.md` (C-E00-014..016). tasks-meta snapshots vendor from the tag pin via `scripts/refresh-tasks-meta.ts` |
