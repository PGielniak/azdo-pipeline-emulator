...
- [!] **E03-S02-T05 — Local file lookup must be case-sensitive on a case-insensitive filesystem** *(In progress 2026-08-22: claimed by Claude session on branch `e03-s02-t05-case-sensitive-lookup` (main checkout). Filed by E12-S03-T01 as a defect found in CI.)*
